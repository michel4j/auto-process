...
def kappaVectorx(alpha):
    return vec3([-math.sin(alpha), 0, -math.cos(alpha)])
...
#GONIOMETER_NAME = "EMBL MiniKappa"
#GONIOMETER_AXES_NAMES = ("Omega","Kappa","Phi")
#GONIOMETER_AXES = [ez, kappaVector(-24/r2d), ez]
#GONIOMETER_DATUM = (0,0,45)  # in degree

# -- DLS's MiniKappa Goniometer definitions --
GONIOMETER_NAME = "CLS MiniKappa"
GONIOMETER_AXES_NAMES = ("Omega","Kappa","Phi")
GONIOMETER_AXES = [ex, kappaVectorx(-24/r2d), ex]
GONIOMETER_DATUM = (0,0,45)  # in degree
